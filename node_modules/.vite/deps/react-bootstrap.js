...
var Button = React3.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Component2, Object.assign({}, props, buttonProps, {
    ref
  }));
});
...
var CloseButton = React7.forwardRef(({
  className,
  variant,
...
var Alert = React8.forwardRef((uncontrolledProps, ref) => {
  const {
    bsPrefix,
    show = true,
...
var Button2 = React12.forwardRef(({
  ...
  return (0, import_jsx_runtime13.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames10.default)(className, prefix, active && "active", variant && `${prefix}-${variant}`, size2 && `${prefix}-${size2}`, props.href && disabled && "disabled")
  });
});
...
function useUpdateEffect(fn, deps) {
  const isFirst = (0, import_react18.useRef)(true);
...
var Container = React32.forwardRef(({
  ...
  return (0, import_jsx_runtime33.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames28.default)(className, fluid ? `${prefix}${suffix}` : prefix)
  });
});
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react24.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react24.useState)(defaultValue);
  ...
  return [isProp ? propValue : stateValue, (0, import_react24.useCallback)((...args) => {
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react25.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react26.useCallback)((nextState) => {
    if (!isMounted()) return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  } = _ref, config = _objectWithoutPropertiesLoose3(_ref, _excluded3);
  const prevModifiers = (0, import_react27.useRef)(modifiers);
  const popperInstanceRef = (0, import_react27.useRef)();
  const update = (0, import_react27.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react27.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react27.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react27.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react27.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const handleMouseCapture = (0, import_react28.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react29.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react29.useRef)(false);
  const {
    flip,
    offset,
    rootCloseEvent,
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react30.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react30.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react30.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react30.useState)(true);
  let value = (0, import_react30.useMemo)(() => ({
  ...
  return (0, import_react30.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react30.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react30.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react30.default).createElement((0, import_react30.default).Fragment, null, props.children);
  }
  return (0, import_react30.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react31.useContext)(DropdownContext_default) || {};
  const handleClick = (0, import_react31.useCallback)((e) => {
    toggle(!show, e);
  }, [show, toggle]);
  const props = {
    id,
...
var Context = (0, import_react33.createContext)(canUseDOM_default ? window : void 0);
var WindowProvider = Context.Provider;
function useWindow() {
  return (0, import_react33.useContext)(Context);
}
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react34.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react34.useRef)(null);
  const focusInDropdown = (0, import_react34.useRef)(false);
  const onSelectCtx = (0, import_react34.useContext)(SelectableContext_default);
  const toggle = (0, import_react34.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  const context4 = (0, import_react34.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  useEventListener((0, import_react34.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
var useIsomorphicEffect_default2 = isDOM2 || isReactNative2 ? import_react35.useLayoutEffect : import_react35.useEffect;
...
var Feedback = React55.forwardRef(
  ...
  ({
    ...
    ...props,
    ref,
    className: (0, import_classnames40.default)(className, `${type}-${tooltip ? "tooltip" : "feedback"}`)
  })
);
...
var FormCheckInput = React57.forwardRef(({
  ...
  return (0, import_jsx_runtime52.jsx)(Component2, {
    ...
    type,
    id: id || controlId,
    className: (0, import_classnames41.default)(className, bsPrefix, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormCheck = React59.forwardRef(({
  ...
  return (0, import_jsx_runtime54.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime54.jsx)("div", {
      style,
      className: (0, import_classnames43.default)(className, hasLabel && bsPrefix, inline && `${bsPrefix}-inline`, reverse && `${bsPrefix}-reverse`, type === "switch" && bsSwitchPrefix),
...
var FormControl = React60.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames44.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size2 && `${bsPrefix}-${size2}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormLabel = React63.forwardRef(({
  ...
  const classes = (0, import_classnames46.default)(className, bsPrefix, visuallyHidden && "visually-hidden", column && columnClass);
...
var FormSelect = React65.forwardRef(({
  ...
  return (0, import_jsx_runtime62.jsx)("select", {
    ...
    size: htmlSize,
    ref,
    className: (0, import_classnames48.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var FormText = React66.forwardRef(
  ...
  ({
    ...
    return (0, import_jsx_runtime63.jsx)(Component2, {
      ...props,
      ref,
      className: (0, import_classnames49.default)(className, bsPrefix, muted && "text-muted")
    });
  }
);
...
var Switch = React67.forwardRef((props, ref) => (0, import_jsx_runtime64.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Form = React69.forwardRef(({
  ...
  ...props,
  ref,
  className: (0, import_classnames51.default)(className, validated && "was-validated")
}));
...
var InputGroup = React71.forwardRef(({
  ...
  return (0, import_jsx_runtime69.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime69.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames53.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, hasValidation && "has-validation")
    })
  });
});
...
function useMergedRefs(refA, refB) {
  return (0, import_react49.useMemo)(() => mergeRefs(refA, refB), [refA, refB]);
}
...
function useNavItem({
  ...
  const navContext = (0, import_react50.useContext)(NavContext_default);
...
var NavItem = React73.forwardRef((_ref, ref) => {
  let {
    ...
    active,
    eventKey
  } = _ref, options = _objectWithoutPropertiesLoose6(_ref, _excluded6);
...
var Nav = React74.forwardRef((_ref, ref) => {
  ...
  const forceUpdate = useForceUpdate();
  const needsRefocusRef = (0, import_react51.useRef)(false);
  ...
  const listNode = (0, import_react51.useRef)(null);
...
var ListGroupItem = React75.forwardRef(({
  ...
  return (0, import_jsx_runtime72.jsx)(Component2, {
    ...
    ...navItemProps,
    onClick: handleClick,
    className: (0, import_classnames54.default)(className, bsPrefix, meta.isActive && "active", disabled && "disabled", variant && `${bsPrefix}-${variant}`, action && `${bsPrefix}-action`)
  });
});
...
var ListGroup = React76.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime73.jsx)(Nav_default, {
    ...
    ...controlledProps,
    as,
    className: (0, import_classnames55.default)(className, bsPrefix, variant && `${bsPrefix}-${variant}`, horizontalVariant && `${bsPrefix}-${horizontalVariant}`, numbered && `${bsPrefix}-numbered`)
  });
});
...
function useCallbackRef2() {
  return (0, import_react52.useState)(null);
}
...
function NoopTransition({
  ...
  const child = (0, import_react56.cloneElement)(children, {
    ref: combinedRef
  });
...
var RTGTransition = React77.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime74.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function ImperativeTransition({
  ...
  const combinedRef = useMergedRefs_default2(ref, getChildRef(children));
  return exited && !inProp ? null : (0, import_react58.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime75.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime75.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime75.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react59.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react59.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react59.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react59.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime76.jsx)("div", Object.assign({}, props)),
    ...
    onEntering,
    onEntered
  } = _ref, rest = _objectWithoutPropertiesLoose10(_ref, _excluded10);
  const ownerWindow = useWindow();
  const container = useWaitForDOMRef(containerRef);
  const modal = useModalManager(providedManager);
  const isMounted = useMounted();
  const prevShow = usePrevious(show);
  const [exited, setExited] = (0, import_react59.useState)(!show);
  const lastFocusRef = (0, import_react59.useRef)(null);
  (0, import_react59.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react59.useRef)();
  const removeKeydownListenerRef = (0, import_react59.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime76.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime76.jsx)(import_jsx_runtime76.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime76.jsxs)(import_jsx_runtime76.Fragment, {
...
var ModalDialog = React82.forwardRef(({
  ...
  return (0, import_jsx_runtime78.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames57.default)(dialogClass, className, size2 && `${bsPrefix}-${size2}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
    children: (0, import_jsx_runtime78.jsx)("div", {
      className: (0, import_classnames57.default)(`${bsPrefix}-content`, contentClassName),
      children
    })
  });
});
...
var AbstractModalHeader = React84.forwardRef(({
  ...
  const context4 = (0, import_react60.useContext)(ModalContext_default);
  ...
  return (0, import_jsx_runtime81.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime80.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick
    })]
...
var Modal2 = React87.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react61.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react61.useState)(false);
  const waitingForMouseUpRef = (0, import_react61.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react61.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react61.useRef)(null);
  const [modal, setModalRef] = useCallbackRef2();
  const mergedRef = useMergedRefs_default(ref, setModalRef);
  const handleHide = useEventCallback(onHide);
  const isRTL = useIsRTL();
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal");
  const modalContext = (0, import_react61.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react61.useCallback)((backdropProps) => (0, import_jsx_runtime84.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames61.default)(`${bsPrefix}-backdrop`, backdropClassName, !animation && "show")
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime84.jsx)("div", {
    ...
    className: (0, import_classnames61.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && "show"),
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime84.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime84.jsx)(ModalContext_default.Provider, {
    value: modalContext,
...
var NavLink = React89.forwardRef(({
  ...
  return (0, import_jsx_runtime86.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames63.default)(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
var Nav2 = React90.forwardRef((uncontrolledProps, ref) => {
  ...
  return (0, import_jsx_runtime87.jsx)(Nav_default, {
    as,
    ref,
    activeKey,
    className: (0, import_classnames64.default)(className, {
      [bsPrefix]: !isNavbar,
...
var NavbarCollapse = React92.forwardRef(({
  ...
  return (0, import_jsx_runtime89.jsx)(Collapse_default, {
...
var NavbarToggle = React93.forwardRef(({
  ...
  return (0, import_jsx_runtime90.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime90.jsx)("span", {
...
var OffcanvasToggling = React95.forwardRef(({
  ...
  return (0, import_jsx_runtime92.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime95.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React98.forwardRef(({
  ...
  const renderBackdrop = (0, import_react67.useCallback)((backdropProps) => (0, import_jsx_runtime95.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime97.jsxs)(import_jsx_runtime96.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime95.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React99.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React101.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime100.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var NavDropdown = React102.forwardRef(({
  ...
  return (0, import_jsx_runtime102.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames74.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime101.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
...
var Overlay = React103.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react71.useState)(!props.show);
...
var Popover = React107.forwardRef(({
  ...
  return (0, import_jsx_runtime106.jsxs)("div", {
    ...
    className: (0, import_classnames77.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
    children: [(0, import_jsx_runtime105.jsx)("div", {
      className: "popover-arrow",
      ...arrowProps
    }), body ? (0, import_jsx_runtime105.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
var Tooltip = React108.forwardRef(({
  ...
  return (0, import_jsx_runtime108.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames78.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react72.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React109.forwardRef(({
  ...
  const popperRef = (0, import_react73.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react73.useState)(null);
  ...
  return (0, import_jsx_runtime109.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React109.cloneElement(overlay, {
        ...
        popper,
        hasDoneInitialMeasure,
        className: (0, import_classnames79.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react74.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, getChildRef(children));
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react74.useRef)("");
  ...
  const handleShow = (0, import_react74.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react74.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react74.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react74.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react74.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react74.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react74.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime112.jsxs)(import_jsx_runtime111.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react74.cloneElement)(children, triggerProps), (0, import_jsx_runtime110.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React111.forwardRef(({
  ...
  return (0, import_jsx_runtime113.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames80.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime114.jsxs)(Component2, {
      className: (0, import_classnames80.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime113.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React111.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime114.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React112.forwardRef(({
  ...
  return (0, import_jsx_runtime115.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames81.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames82.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React113.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime116.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime118.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames83.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime118.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
...
var ProgressBar = React115.forwardRef(({
  ...
  return (0, import_jsx_runtime118.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react75.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
var Ratio = React116.forwardRef(({
  ...
  return (0, import_jsx_runtime119.jsx)("div", {
    ...
    className: (0, import_classnames84.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Row = React117.forwardRef(({
  ...
  return (0, import_jsx_runtime120.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames85.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React118.forwardRef(({
  ...
  return (0, import_jsx_runtime121.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames86.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
function useTabPanel(_ref) {
  let {
    ...
    onExiting,
    onExited
  } = _ref, props = _objectWithoutPropertiesLoose11(_ref, _excluded11);
  const context4 = (0, import_react76.useContext)(TabContext_default);
...
var ToastFade = React128.forwardRef((props, ref) => (0, import_jsx_runtime133.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React130.forwardRef(({
  ...
  const context4 = (0, import_react78.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
